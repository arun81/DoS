import requests,json,re,threading,urlparse,os,glob,time
...
"""
	if action == "START":
		print banner
	if action == "YT_SUB":
		loaded = SUCCESS_LOGIN + FAILED_LOGIN
		s = "[+] Successful Logins   = {} / {} Acc Gmail ({}) \n[!] Failed Logins   	= {} / {} Acc Gmail ({})\n[Channel ID : {}] Live subscribers count = {}\n"
		print banner
		print s.format(SUCCESS_LOGIN,loaded,combo_file,FAILED_LOGIN,loaded,combo_file,channel_id,live_count)
	if action == "YT_LIKE":
		loaded = SUCCESS_LOGIN + FAILED_LOGIN
		s = "[+] Successful Logins        = {}\n[+] Successful likes      = {}\n[!] Failed Logins = {}\n[!] Failed likes  = {}"
		print banner
